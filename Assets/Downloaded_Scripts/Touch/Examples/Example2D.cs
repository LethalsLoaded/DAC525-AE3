...
public class Example2D : MonoBehaviour
{
    ...
    private void CheckActions()
    {
        ...
        foreach (var t in Input.touches.CheckRayHit2D(layersToIgnore))
                ...
                switch (t.action)
                {
                    ...
                    case TouchHandler.actions.Drag:
                        ...
                        if (!t.phase.IsDone())
                        {
                            ...
                            t.raycastHit2D.rigidbody.MovePosition(new Vector2(t.raycastHit2D.point.x,
                                t.raycastHit2D.point.y));
