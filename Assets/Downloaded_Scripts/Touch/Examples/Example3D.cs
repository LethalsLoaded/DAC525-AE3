...
{
    public bool grapple;
    private readonly int[] layersToIgnore = {8};
    ...
    private void OnGUI()
    {
        ...
        var rect = new Rect(0, 5, Screen.width, 75);
    ...
    private void Update()
    {
        ...
        else if (Input.touches.GetDoubleSwipeDirection() != TouchHandler.directions.None)
        {
            ...
            {
                text = "Two Finger Swipe - Pan Right";
                Camera.main.transform.Rotate(Vector3.up * Time.deltaTime * 90);
            }
            else
            {
                text = "Two Finger Swipe - Pan Left";
    ...
    private void CheckActions()
    {
        ...
        foreach (var t in Input.touches.CheckRayHit3D(layersToIgnore))
            if (t.raycastHit.rigidbody != null)
            {
                ...
                switch (t.action)
                {
                    ...
                    case TouchHandler.actions.Drag:
                        ...
                        t.raycastHit.rigidbody.MovePosition(new Vector3(t.raycastHit.point.x,
                            t.raycastHit.rigidbody.position.y, t.raycastHit.point.z));
